         ...
         return (
            <View style={[this.props.Language=='AR'? styles.row:styles.rowReversed,styles.shadow,{width:width,height:60,backgroundColor: '#383B43',alignItems:'center' }]}>
               <TouchableOpacity onPress={() => this.props.navigation.navigate('AppRoutes')}>
                ...
                <Text style={{ flex:1,textAlign:'center',color: '#FFFFFF', fontSize: 16,fontFamily:'segoe_bold' }}>المدفوعات</Text>
         ...
         return (
            <View style={[this.props.Language=='AR'? styles.row:styles.rowReversed,styles.shadow,{width:width,height:60,backgroundColor: '#383B43',}]}>
               ...
               <Icon name="navicon" style={{ color: '#fff', fontSize: 30 ,paddingHorizontal:20}} />
                ...
                <Text style={{ flex:1,textAlign:'center',color: '#FFFFFF', fontSize: 16,fontFamily:'segoe_bold' }}>Payments</Text>              
                <TouchableOpacity onPress={() => this.props.navigation.navigate('AppRoutes')} >
   ...
   renderItem(index , item) {
      return (
         ...
         style={[styles.shadow,{width: '98%', height:height*0.15,backgroundColor:'#FBFAF9',alignItems:'center',margin:4}]}>
               <View style={[this.props.Language=='AR'?styles.row:styles.rowReversed,{ width: '100%',height:'100%',alignItems:'center'}]}>
                <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                  <Text style={{fontSize:17,textAlign:'center',color:'#707070',fontFamily:'segoe',}}>
                     {this.props.Language=='AR'?'القيـمة':'Value'}</Text>
                  <Text style={{fontSize:14,textAlign:'center',color:'#969696',fontFamily:'segoe',marginTop:10}}>5050</Text>
                </View>
                <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text style={{fontSize:17,textAlign:'center',color:'#707070',fontFamily:'segoe',}}>
                     {this.props.Language=='AR'?'التاريـخ':'Date'}</Text>
                  <Text style={{fontSize:14,textAlign:'center',color:'#969696',fontFamily:'segoe',marginTop:10}}>24-6-2020</Text>
                </View>
                <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text style={{fontSize:17,textAlign:'center',color:'#707070',fontFamily:'segoe',}}>
                     {this.props.Language=='AR'?'أسم المستلـم':'Recipien name'}</Text>
                  <Text style={{fontSize:14,textAlign:'center',color:'#969696',fontFamily:'segoe',marginTop:10}}>omar sadaka</Text>
                </View>
                <View style={{width:40,height:'100%',alignItems:'center',justifyContent:'center',backgroundColor:'#3FC1CF'}}>
                <Text style={{fontSize:27,textAlign:'center',color:'#FAFAFA',fontFamily:'segoe_bold',}}>
                   {index}</Text>
                </View>
...
// redux
export default connect(mapStateToProps, { SetLoading  })(Payments)
